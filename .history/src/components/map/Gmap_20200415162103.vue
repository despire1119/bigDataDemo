...
const bass={...this.modeList.find(mod => mod.mod === this.viewMode).bassConfig,zoom:this.transRate(this.FONT_REM_RATE) }
     // const bass = Object.assign(this.modeList.find(mod => mod.mod === this.viewMode).bassConfig, { zoom: this.transRate(this.FONT_REM_RATE) })
      console.log('地图比例', bass.zoom)
