...
console.log(this.qmap.map.getZoom() );
    ...
    transRate() {
         const [minZ,maxZ,minCw,maxCw] =[1,1000,1344,22400]
        return parseFloat( this.CONFIG_WIDTH/ (22400-1344) * (maxZ-minZ)+minZ)   
    },
    bind() {
    ...
    init() {
     const bass = Object.assign(this.modeList.find(mod => mod.mod === this.viewMode).bassConfig, { zoom: this.transRate() })
